...
router.post('/', checkJwt, async (req, res, next) => {
    const db = getDb();
    try {
        const { id, firstName, lastName, middleName, email, phoneNumber, countryCode, addressLine1, addressLine2, monthlyRevenue, state, city, postalCode, autoCalculateMRR, theme, isPremium, parentUserId, } = req.body;
